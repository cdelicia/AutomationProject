...
public class TestEnvironmentConfig {
    ...
    public static void initialize() {
        initialize("chrome", "local", Constants.IS_HEADLESS);
    }
    ...
    public static void initialize(String browser, String testEnv, boolean isHeadless) {
        ...
        Dimension size = new Dimension(1920, 1024);
        if (testEnv.equals("local")) {
            switch (browser) {
                ...
                case "safari":
                    ...
                    break;
                case "edge":
                    WebDriverManager.edgedriver().arm64().setup();
                    driver = new EdgeDriver();
                    break;
                case "explorer":
                    WebDriverManager.iedriver().arm64().setup();
